...
export default function PricingSection() {
  ...
  return (
    <section
      id='pricing'
      className='bg-[radial-gradient(circle_at_top,rgba(255,144,69,0.12),transparent_28%),linear-gradient(180deg,#171513_0%,#11100f_100%)] px-4 py-20 text-white sm:px-6 lg:px-8'
    >
